...
This directory contains pre-generated Solidity verifier contracts for UltraHonk proofs. These files are committed to the repository to avoid OOM (out of memory) errors in CI environments with limited resources.
